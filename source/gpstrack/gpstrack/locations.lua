--[[#############################################################################
LOCATION Library: GPS F3X Tracker for Ethos v1.5
...
local locations = {
    {name = "Live Position & Direction", lat = 0.0, lon = 0.0, dir = 100.0, dif = 0, comp = 1},
    {name = "Debug", lat = 53.550707, lon =  9.923472, dir =   9.0, dif = 0, comp = 5},
